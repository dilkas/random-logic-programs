...
% TODO: does the restart policy still matter? If so, update the numbers.
% TODO (for later)
% 1) Use American English
% 2) Avoid the Definition environment (to save space)

% Description of experimental options
% Old options: (<600k experiments)
% number of predicates (2, 4, 8)
% number of variables (2, 4, 8)
% max number of nodes (2, 4, 8)
% max arity (1, 2, 3)
% number of constants (0)
% number of additional clauses (0)
% number of independent pairs (all options)
% New options:
% define each predicate: true
% allow empty bodies: false
% timeout = 60s (for both?)
% disable negative cycles
% probabilities = [0.1, ..., 0.9]
% generate 10 programs (with restarts, restarting arities and independent pairs)
% domain size: 100, 200, 400
% proportion probabilistic: 0.25, 0.5, 0.75
% number of facts: 1k, 10k, 100k
% DERIVATIVE: average spots per constant
% DERIVATIVES: universe size, proportion listed
% NOTE: The distribution of facts is uniformly distributed across predicates
% (because it's easier this way)
% NOTE: number of facts goes up to 75% of the universe

% Empirical tasks:
% 1) make the CP model faster: apply the redundant constraints to predicates
% (not just variables). Check if everything works out.
% 2) motivate either for benchmarking or by comparing parameter learning with ProbFOIL
...
\end{figure} % TODO: describe in the text
