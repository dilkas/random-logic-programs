...
TODO: Review \cite{DBLP:journals/tplp/WangWM15,DBLP:conf/ijcai/AmendolaRT17,DBLP:journals/ai/AmendolaRT20}
...
independence. Stratification is a condition that both logic programs and
probabilistic logic programs need to satisfy to ensure a unique answer
to every query
\cite{DBLP:journals/jlp/BalbinPRM91,DBLP:conf/padl/MantadelisR17}, while
independence is a fundamental concept in probability theory that imposes
structure on the probability distribution and simplifies inference. In the
...
predicate dependency graph. Constraints are usually presented with two
