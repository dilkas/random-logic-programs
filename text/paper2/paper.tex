...
\author{Paulius Dilkas\inst{1} \and Vaishak Belle\inst{1,2}}
...
%  \keywords{Constraint programming \and Probabilistic logic programming \and Statistical relational learning.}
\end{abstract}
