...
\node[text=black,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (205.30, 77.98) {$|\mathcal{P}|$};
\end{scope}
\begin{scope}
\path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
...
\node[text=black,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (205.54, 65.59) {$|\mathcal{V}|$};
\end{scope}
\begin{scope}
\path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
...
\node[text=black,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (205.85, 53.19) {$|\mathcal{C}|$};
\end{scope}
\begin{scope}
\path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
...
\node[text=black,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (189.68, 90.33) {$\mathcal{M}_{\mathcal{C}}-|\mathcal{P}|$};
\end{scope}
\begin{scope}
\path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
...
\node[text=black,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (203.37,163.74) {$\mathcal{M}_{\mathcal{N}}$};
\end{scope}
\begin{scope}
\path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
\definecolor{drawColor}{RGB}{217,95,2}
...
\node[text=black,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (136.94, 78.52) {$\mathcal{M}_{\mathcal{A}}$};
\end{scope}
\begin{scope}
