...
\begin{abstract} % TODO: rewrite
  ...
  the constraint solver Choco \citep{choco}, while novel propagation and entailment
...
% TODO: import related work from my proposal
...
% heads, bodies, formulas.
% CP: decision variables, constraints. So the word 'variable' has two meanings.
...
\begin{example} \label{example:independence}
  ...
  \[
    ...
    \}.
  \]
  The predicate dependency graph (without positivity/negativity)---as defined by
...
% TODO: the number of predicates is also important for performance.

\section{CONCLUSIONS}

% TODO: the positive side (what did we achieve?)
