...
% TODO: heads also have the 'disabled' variable/constant value. and if/then
...
% TODO: turn this into lexChainLessEq
...
% TODO: describe what parameter values were used to test the model (or... not).
