...
% TODO: describe the experimental setup (variables), hardware/software (CPU, anything else?)
% see Downloads/cp2019-wiggles.pdf for an example.
...
% TODO: describe the phase transition in this figure. still, almost 300k
% data points. A phase transition in mean but not
% median, i.e., some instances become really hard, but most remain easy.
\begin{figure*}[t]
  \centering
